...
func getReportFromCacheOrGenerate[T any](c cache.Cache, generator interface{}, generateFn func() (T, []error), defaultVal T) (T, []error) {
	if c != nil {
		cacheKey, err := json.Marshal(generator)
		if err != nil {

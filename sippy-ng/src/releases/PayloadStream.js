...
export default function PayloadStream(props) {
  ...
  const resolvedPath = useResolvedPath('') // Get the base path
  const location = useLocation() // For active tab detection
            ...
            <Paper>
              ...
              >
                <Tab
                  ...
                  value="overview"
                  component={Link}
                  to={`${resolvedPath.pathname}/overview`}
                />
                <Tab
                  label="Calendar"
                  value="calendar"
                  component={Link}
                  to={`${resolvedPath.pathname}/calendar`}
                />
                <Tab
                  label="Payloads"
                  value="payloads"
                  component={Link}
                  to={`${resolvedPath.pathname}/payloads`}
                />
                <Tab
                  label="Test Failures"
                  value="testfailures"
